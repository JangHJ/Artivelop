...
public class keypadCtrl2 : MonoBehaviour
{
    ...
    public void Input_KeyEnter()
    {
        if (KeypadTxt.text == "0909")
        {
            ...
            Fungus.Flowchart.BroadcastFungusMessage("Keypad_ON2");
    ...
    {
        if (coll.gameObject.tag == "Player" && Input.GetKey(KeyCode.E) && fc_event.GetBooleanVariable("keypadON2") == false)
        {
