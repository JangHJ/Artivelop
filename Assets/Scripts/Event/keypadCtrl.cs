...
public class keypadCtrl : MonoBehaviour
{
    ...
    public void Input_KeyEnter()
    {
        if (KeypadTxt.text == "0621")
        {
            ...
            Fungus.Flowchart.BroadcastFungusMessage("Keypad_ON");
    ...
    {
        if (coll.gameObject.tag == "Player" && Input.GetKey(KeyCode.E) && fc_event.GetBooleanVariable("keypadON") == false)
        {
